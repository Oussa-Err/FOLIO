...
export const Hero = () => {
  ...
  return (
    <section
      ref={observerRef}
      className={myElementVisible? `min-h-screen flex gap-4 flex-col justify-center items-start animate-fade-slide-down`: `min-h-screen flex gap-4 flex-col justify-center items-start`}
      id="Hero"
    >
